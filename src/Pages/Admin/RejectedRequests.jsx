...
import { fetchRejectedRequests } from '../../Logic/slices/api_slice/apiActions';
import { useLayoutEffect } from 'react';
export default function RejectedRequests() {
    const token = useSelector(state => state.auth.token);
    const dispatch = useDispatch();
    useLayoutEffect(() => {
        dispatch(fetchRejectedRequests(token));
    }, []);
    const requests = useSelector(state => state.api.RejectedRequests);
