...
import { fetchAcceptedRequests } from '../../Logic/slices/api_slice/apiActions';
import { useLayoutEffect } from 'react';
export default function AcceptedRequests() {
    const token = useSelector(state => state.auth.token);
    const dispatch = useDispatch();
    useLayoutEffect(() => {
        dispatch(fetchAcceptedRequests(token));
    }, [0]);
    const requests = useSelector(state => state.api.AcceptedRequests);
